...
* Fork the CMAS-CENTER repository (https://github.com/CMASCenter/EPA-CMAQ)  using the following instructions
...
{% highlight csh %}
using ssh    git clone -b 5.2Beta git@github.com:lizadams/CMAQ.git CMAQ_v5.2Beta
using https  git clone -b 5.2Beta https://github.com/lizadams/CMAQ.git CMAQ_v5.2Beta
{% endhighlight %}
